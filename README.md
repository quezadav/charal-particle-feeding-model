...
1. **Spatial diffusion**: food affects gut fullness, but not movement.
2. **Resource taxis**: food affects gut fullness, and particle movement responds to the spatial gradient of the food field.
